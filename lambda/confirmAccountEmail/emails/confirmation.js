                  ...
                  <tr>
                    <td class="wrapper">
                      <table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td>
                            <img src="https://pips-pro.com/images/logo.png">
                            <br>
                            <br>
                            <br>
                          </td>
                        ...
                        <tr>
                          <td>
                            <p>Hi ${data.name},</p>
                            <br>
                            <p>Thank you for your registration at <a href="${
                                process.env.HOST
                            }" target="_blank">pips-pro.com</a>.</p>
                            <br>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0">
                                      <tbody>
                                        <tr>
                                          <td> <a href="${
                                              process.env.HOST
                                          }#buy-signals-1" target="_blank">Change mobile number</a> </td>
                                        </tr>
                                      </tbody>
                                    </table>
                                  </td>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0">
                                      <tbody>
                                        <tr>
                                          <td> <a href="${
                                              process.env.HOST
                                          }#buy-signals-1" target="_blank">Purchase a Signal Package</a> </td>
                                        </tr>
                                      </tbody>
                                    </table>
                                  </td>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0">
                                      <tbody>
                                        <tr>
                                          <td> <a href="${
                                              process.env.HOST
                                          }my-account/transactions.html" target="_blank">View Transactions</a> </td>
                                        </tr>
                                      </tbody>
                                    </table>
                                  </td>
