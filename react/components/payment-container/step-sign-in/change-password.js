    ...
    render() {
        ...
        return (
            <form onSubmit={this.changeUserPassword.bind(this)}>
                ...
                <div className={"hidden form-group " + (emailError ? 'has-error' : '')}>
                ...
                <div className="form-group">
                    <button className="btn btn-default" onClick={this.changeUserPassword.bind(this)} disabled={submitting}>Change Password<div className={'ball-clip-rotate ' + (submitting ? '' : 'hidden')}><div></div></div></button>
                </div>


                <p><button type="button" className="btn btn-xs btn-ouline" onClick={this.cancelChangePassword.bind(this)}>Go back</button></p>
