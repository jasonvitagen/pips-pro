        ...
        return (
            <form onSubmit={this.editUserAccount.bind(this)}>
                <div className={'form-group ' + (nameError ? 'has-error' : '')}>
                    <label className="sr-only control-label" htmlFor="name">
                        name
                        <span className=" "> </span>
                    </label>
                    <input
                        ...
                        type="text"
                        value={name}
                        onChange={this.type.bind(this, 'name')}
                        placeholder="Name"
                ...
                <div
                    className={
                        'form-group ' + (mobileError ? 'has-error' : '')
                    }>
                    <label className="sr-only control-label" htmlFor="mobile">
                        mobile
                        <span className=" "> </span>
                    </label>
                    <input
                ...
                <div className="form-group">
                    <button
                        ...
                        onClick={this.editUserAccount.bind(this)}
                        disabled={submitting}>
                        Edit Account
                        <div
                            className={
                ...
                <p>
                    <button
                        ...
                        onClick={this.cancelEditAccount.bind(this)}>
                        Go back
                    </button>
                </p>
            </form>
