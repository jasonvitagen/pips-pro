    ...
    <!doctype html>
        <html>
          <head>
            ...
            <title>Reset Your Password at Pips-Pro.com</title>
            <style>
              /* -------------------------------------
                  GLOBAL RESETS
              ------------------------------------- */
                          ...
                          <table border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                              <td>
                                <p>Hi,</p>
                                <br>
                                <p>We've received a request to reset your password at pips-pro.com.</p>
                                    ...
                                    <tr>
                                      <td align="left">
                                        <table border="0" cellpadding="0" cellspacing="0">
                                          <tbody>
                                            <tr>
                                              <td><a href="${process.env.HOST}?resetpassword=${data.token}" target="_blank">Reset Your Password</a></td>
                                            </tr>
                                          </tbody>
                                        </table>
                                      </td>
