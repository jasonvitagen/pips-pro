    ...
    <!doctype html>
        <html>
          <head>
            ...
            <title>Your Order at Pips-Pro.com</title>
            <style>
              /* -------------------------------------
                  GLOBAL RESETS
              ------------------------------------- */
                          ...
                          <table border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                              <td>
                                <p>Hi ${data.Name},</p>
                                <br>
                                <p>Your payment for ${data.SignalPackage}-month signal package at pips-pro.com is successful.</p>
                                <br>
                                <p><b>Your order info:</b></p>
                                <p><u>Reference Number</u></p>
                                <p>${data.RefNo}</p>
                                <p><u>Amount</u></p>
                                ...
                                <p>${moment(data.packageExpireAt).format('DD/MM/YYYY hh:mm A')}</p>
                                <br>
